# Manual Completo de Cálculo de Custos na Importação (Versão Corrigida)
...
- **Base**: Valor aduaneiro + II
- **Alíquotas**: Conforme TIPI
- **Cálculo**: IPI = (Valor Aduaneiro + II) × Alíquota IPI
- **Observação**: Importador é equiparado à indústria[^1][^2]

#### PIS-Importação e COFINS-Importação

**Para mercadorias normais:**

- PIS: 2,10% sobre valor aduaneiro
- COFINS: 9,65% sobre valor aduaneiro[^3]

**Para serviços:**

- PIS: 1,65% sobre valor aduaneiro
- COFINS: 7,60% sobre valor aduaneiro[^3]

### Impostos Estaduais

#### ICMS

- **Base**: Valor aduaneiro + II + IPI + PIS + COFINS + despesas aduaneiras + próprio ICMS (cálculo "por dentro")
- **Fórmula**: ICMS = [(Base sem ICMS) ÷ (1 - Alíquota)] × Alíquota
- **Alíquotas**: Variáveis por estado (4% a 25%)[^4][^5]

## Créditos Tributários por Regime

### Lucro Real (Regime Não Cumulativo)

#### Créditos de PIS/COFINS

- **Mercadorias normais**: Crédito integral de 2,10% (PIS) + 9,65% (COFINS)
- **Serviços**: Crédito de 1,65% (PIS) + 7,60% (COFINS)
- **Mercadorias monofásicas**: Mesmo tratamento das normais
- **Base**: Valor que serviu de base para o pagamento na importação[^3]

#### Créditos de IPI

- **Direito integral** ao crédito do IPI pago na importação
- Pode destacar IPI nas vendas e transferir crédito aos clientes[^6][^7]

### Lucro Presumido (Regime Cumulativo)

#### Créditos de PIS/COFINS

- **Não possui direito** aos créditos de PIS/COFINS pagos na importação
- Valores integram definitivamente o custo da mercadoria[^8][^9]

#### Créditos de IPI

- **Possui direito** ao crédito do IPI pago na importação
- Pode destacar IPI nas vendas[^7][^1]
...
## Formação de Preço de Venda (Corrigida)
...
### Exemplo 2: Cosmético Monofásico (Lucro Real)
...
Como importador equiparado à indústria, deve-se:
...
A formação correta do preço de venda deve sempre considerar:
