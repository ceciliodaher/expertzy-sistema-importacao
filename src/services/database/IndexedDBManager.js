...
class IndexedDBManager {
    ...
    initializeSchema() {
        ...
        this.db.version(5).stores({
            ...
            costing_results: '++id, di_id, numero_di, regime_tributario, custos_4_tipos, detalhamento_completo, total_creditos, economia_creditos, percentual_economia, incentivos_aplicados, reducao_base_calculada, credito_presumido_calculado, fcp_aplicado_real, beneficios_fiscais_detalhados, ready_for_pricing, timestamp, versao_calculo, [di_id+regime_tributario]',
